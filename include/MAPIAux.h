...
#define PR_ATTACH_CONTENT_ID						MAKE_SCODE(0, 0x3712, PT_TSTRING)
#define PR_ATTACH_CONTENT_ID_W						MAKE_SCODE(0, 0x3712, PT_UNICODE)
#define PR_ATTACH_CONTENT_ID_A						MAKE_SCODE(0, 0x3712, PT_STRING8)

// Additional display attributes, to supplement PR_DISPLAY_TYPE.
#define PR_DISPLAY_TYPE_EX							MAKE_SCODE(0, 0x3905, PT_LONG)

#define PR_MSG_EDITOR_FORMAT						MAKE_SCODE(0, 0x5909, PT_LONG)

#define PR_ROH_FLAGS								MAKE_SCODE(0, 0x6623, PT_LONG)

#define PR_ROH_PROXY_AUTH_SCHEME					MAKE_SCODE(0, 0x6627, PT_LONG)
