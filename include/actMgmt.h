...
#define PR_PRIMARY_SEND_ACCT MAKE_SCODE(0, 0x0e28, PT_UNICODE)
#define PR_NEXT_SEND_ACCT MAKE_SCODE(0, 0x0e29, PT_UNICODE)

// Common Properties - 0x0001 : 0x00FF
// ===================================
#define PROP_ACCT_ID MAKE_SCODE(0, 0x0001, PT_LONG)
#define PROP_ACCT_NAME MAKE_SCODE(0, 0x0002, PT_UNICODE)
#define PROP_ACCT_MINI_UID MAKE_SCODE(0, 0x0003, PT_LONG)
#define PROP_ACCT_USER_DISPLAY_NAME MAKE_SCODE(0, 0x000B, PT_UNICODE)
#define PROP_ACCT_USER_EMAIL_ADDR MAKE_SCODE(0, 0x000C, PT_UNICODE)
#define PROP_ACCT_STAMP MAKE_SCODE(0, 0x000D, PT_UNICODE)
#define PROP_ACCT_SEND_STAMP MAKE_SCODE(0, 0x000E, PT_UNICODE)
#define PROP_ACCT_IS_EXCH MAKE_SCODE(0, 0x0014, PT_LONG)
#define PROP_ACCT_DELIVERY_STORE MAKE_SCODE(0, 0x0018, PT_BINARY)
#define PROP_ACCT_DELIVERY_FOLDER MAKE_SCODE(0, 0x0019, PT_BINARY)
#define PROP_ACCT_SENTITEMS_EID MAKE_SCODE(0, 0x0020, PT_BINARY)
#define PROP_ACCT_PREFERENCES_UID MAKE_SCODE(0, 0x0022, PT_BINARY)

// General Internet Mail Properties - 0x0100 : 0x01FF
// ==================================================
#define PROP_INET_SERVER MAKE_SCODE(0, 0x0100, PT_UNICODE)
#define PROP_INET_USER MAKE_SCODE(0, 0x0101, PT_UNICODE)
#define PROP_INET_PASSWORD MAKE_SCODE(0, 0x0102, PT_UNICODE)
#define PROP_INET_PORT MAKE_SCODE(0, 0x0104, PT_LONG)
#define PROP_INET_SSL MAKE_SCODE(0, 0x0105, PT_LONG)
#define PROP_INET_USE_SPA MAKE_SCODE(0, 0x0108, PT_LONG)

// Specific SMTP Properties - 0x0200 : 0x02FF
// ==========================================
#define PROP_SMTP_SERVER MAKE_SCODE(0, 0x0200, PT_UNICODE)
#define PROP_SMTP_PORT MAKE_SCODE(0, 0x0201, PT_LONG)
#define PROP_SMTP_SSL MAKE_SCODE(0, 0x0202, PT_LONG)
#define PROP_SMTP_USE_AUTH MAKE_SCODE(0, 0x0203, PT_LONG)
#define PROP_SMTP_USER MAKE_SCODE(0, 0x0204, PT_UNICODE)
#define PROP_SMTP_PASSWORD MAKE_SCODE(0, 0x0205, PT_UNICODE)
#define PROP_SMTP_USE_SPA MAKE_SCODE(0, 0x0207, PT_LONG)
#define PROP_SMTP_AUTH_METHOD MAKE_SCODE(0, 0x0208, PT_LONG)
#define PROP_SMTP_SECURE_CONNECTION MAKE_SCODE(0, 0x020A, PT_LONG)

// Specific POP Properties - 0x1000 : 0x10FF
// =========================================
#define PROP_POP_LEAVE_ON_SERVER MAKE_SCODE(0, 0x1000, PT_LONG)

// Specific MAPI Properties - 0x2000 : 0x20FF
// ==========================================
#define PROP_MAPI_IDENTITY_ENTRYID MAKE_SCODE(0, 0x2002, PT_BINARY)
#define PROP_MAPI_EMSMDB_UID MAKE_SCODE(0, 0x2009, PT_BINARY)
#define PROP_MAPI_TRANSPORT_FLAGS MAKE_SCODE(0, 0x2010, PT_BINARY)
