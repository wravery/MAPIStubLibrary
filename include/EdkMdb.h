...
#define	PR_PROFILE_VERSION				PROP_TAG( PT_LONG,		pidProfileMin+0x00)		// 0x6600
#define	PR_PROFILE_CONFIG_FLAGS			PROP_TAG( PT_LONG,		pidProfileMin+0x01)		// 0x6601
#define	PR_PROFILE_HOME_SERVER			PROP_TAG( PT_STRING8,	pidProfileMin+0x02)		// 0x6602
#define	PR_PROFILE_USER					PROP_TAG( PT_STRING8,	pidProfileMin+0x03)		// 0x6603
#define	PR_PROFILE_CONNECT_FLAGS		PROP_TAG( PT_LONG,		pidProfileMin+0x04)		// 0x6604
#define PR_PROFILE_TRANSPORT_FLAGS		PROP_TAG( PT_LONG,		pidProfileMin+0x05)		// 0x6605
#define	PR_PROFILE_UI_STATE				PROP_TAG( PT_LONG,		pidProfileMin+0x06)		// 0x6606
#define	PR_PROFILE_UNRESOLVED_NAME		PROP_TAG( PT_STRING8,		pidProfileMin+0x07)		// 0x6607
#define	PR_PROFILE_UNRESOLVED_NAME_A	PROP_TAG( PT_STRING8,		pidProfileMin+0x07)
#define	PR_PROFILE_UNRESOLVED_NAME_W	PROP_TAG( PT_UNICODE,		pidProfileMin+0x07)
#define	PR_PROFILE_UNRESOLVED_SERVER	PROP_TAG( PT_STRING8,		pidProfileMin+0x08)		// 0x6608
#define PR_PROFILE_BINDING_ORDER		PROP_TAG( PT_STRING8,		pidProfileMin+0x09)		// 0x6609
#define PR_PROFILE_MAX_RESTRICT			PROP_TAG( PT_LONG,			pidProfileMin+0x0D)		// 0x660D
#define	PR_PROFILE_AB_FILES_PATH		PROP_TAG( PT_STRING8,		pidProfileMin+0x0E)		// 0x660E
#define	PR_PROFILE_AB_FILES_PATH_W		PROP_TAG( PT_UNICODE,		pidProfileMin+0x0E)
#define PR_PROFILE_OFFLINE_STORE_PATH	PROP_TAG( PT_STRING8,		pidProfileMin+0x10)		// 0x6610
#define PR_PROFILE_OFFLINE_STORE_PATH_W	PROP_TAG( PT_UNICODE,		pidProfileMin+0x10)
#define PR_PROFILE_OFFLINE_INFO			PROP_TAG( PT_BINARY,		pidProfileMin+0x11)		// 0x6611
#define	PR_PROFILE_HOME_SERVER_DN		PROP_TAG( PT_STRING8,		pidProfileMin+0x12)		// 0x6612
#define	PR_PROFILE_HOME_SERVER_ADDRS	PROP_TAG( PT_MV_STRING8,	pidProfileMin+0x13)		// 0x6613
//ptag.h: #define PR_PROFILE_ADDR_TIMESTAMP		PROP_TAG( PT_I8,	pidSpecialMin+0x16)		// 0x6686
#define PR_PROFILE_ADDR_INFO			PROP_TAG( PT_BINARY,		pidSpecialMin+0x17)		// 0x6687
//ptag.h: #define PR_PROFILE_DISPLAYNAME_SET	PROP_TAG( PT_LONG,	pidSpecialMin+0x18)		// 0x6688
#define PR_PROFILE_OPTIONS_DATA			PROP_TAG( PT_BINARY,		pidSpecialMin+0x19)		// 0x6689
// PR_PROFILE_OPTIONS_DATA+1, +2, ... has more options data. See Ec{Set,Get}OptionsData.
#define PR_PROFILE_SECURE_MAILBOX		PROP_TAG( PT_BINARY,		pidSecureProfileMin+0)	// 0x67F0
// Profile properties below this point collide with prop tags after pidStoreMin.  This
// doesn't appear to be a problem since these apply to entirely different objects.
#define PR_DISABLE_WINSOCK				PROP_TAG( PT_LONG,			pidProfileMin+0x18)		// 0x6618
#define	PR_PROFILE_AUTH_PACKAGE			PROP_TAG( PT_LONG,			pidProfileMin+0x19)		// dup tag of PR_USER_ENTRYID    0x6619
...
#define PR_PROFILE_USER_SMTP_EMAIL_ADDRESS_A	PROP_TAG(PT_STRING8,	pidProfileMin+0x41)
...
#define PR_PROFILE_FAVFLD_DISPLAY_NAME_W	PROP_TAG(PT_UNICODE,	pidProfileMin+0x0F)
#define PR_PROFILE_FAVFLD_COMMENT			PROP_TAG(PT_STRING8,	pidProfileMin+0x15)
#define PR_PROFILE_FAVFLD_COMMENT_W			PROP_TAG(PT_UNICODE,	pidProfileMin+0x15)
#define PR_PROFILE_ALLPUB_DISPLAY_NAME		PROP_TAG(PT_STRING8, 	pidProfileMin+0x16)
#define PR_PROFILE_ALLPUB_DISPLAY_NAME_W	PROP_TAG(PT_UNICODE, 	pidProfileMin+0x16)
#define PR_PROFILE_ALLPUB_COMMENT			PROP_TAG(PT_STRING8, 	pidProfileMin+0x17)
#define PR_PROFILE_ALLPUB_COMMENT_W			PROP_TAG(PT_UNICODE, 	pidProfileMin+0x17)

/* Properties for Multiple Offline Address Book support (MOAB) */

#define PR_PROFILE_MOAB					PROP_TAG( PT_STRING8,	pidSpecialMin + 0x0B )
#define PR_PROFILE_MOAB_W				PROP_TAG( PT_UNICODE,	pidSpecialMin + 0x0B )
...
#define PR_PROFILE_ALTERNATE_STORE_TYPE_W		PROP_TAG(PT_UNICODE,0x6500+0xD0)
...
#define PR_FAVORITES_DEFAULT_NAME_W				PROP_TAG( PT_UNICODE,	pidStoreMin+0x1D)
...
#define	PR_EVENTS_ROOT_FOLDER_ENTRYID			PROP_TAG( PT_BINARY,	pidSpecialMin+0x0A)
...
#define	PR_DESIGN_IN_PROGRESS			PROP_TAG( PT_BOOLEAN,	pidExchangeXmitReservedMin+0x04)
#define	PR_SECURE_ORIGINATION			PROP_TAG( PT_BOOLEAN,	pidExchangeXmitReservedMin+0x05)

//Writable, available only for public folders
#define	PR_PUBLISH_IN_ADDRESS_BOOK		PROP_TAG( PT_BOOLEAN,	pidExchangeXmitReservedMin+0x06)
#define	PR_RESOLVE_METHOD				PROP_TAG( PT_LONG,		pidExchangeXmitReservedMin+0x07)
#define	PR_ADDRESS_BOOK_DISPLAY_NAME	PROP_TAG( PT_TSTRING,	pidExchangeXmitReservedMin+0x08)
...
#define PR_REPLICA_LIST					PROP_TAG( PT_BINARY,	pidAdminMin+0x08)
#define PR_OVERALL_AGE_LIMIT			PROP_TAG( PT_LONG,		pidAdminMin+0x09)
...
#define PR_INTERNET_NEWSGROUP_NAME		PROP_TAG( PT_TSTRING,	pidAdminMin+0x17)
#define PR_INTERNET_NEWSGROUP_NAME_A	PROP_TAG( PT_STRING8,	pidAdminMin+0x17)
#define PR_INTERNET_NEWSGROUP_NAME_W	PROP_TAG( PT_UNICODE,	pidAdminMin+0x17)
...
#define	PR_CLIENT_ACTIONS		  		PROP_TAG(PT_BINARY,		pidMessageReadOnlyMin+0x05)
#define	PR_DAM_ORIGINAL_ENTRYID			PROP_TAG(PT_BINARY,		pidMessageReadOnlyMin+0x06)
#define PR_DAM_BACK_PATCHED				PROP_TAG( PT_BOOLEAN,	pidMessageReadOnlyMin+0x07)

// Properties on deferred action error messages
#define	PR_RULE_ERROR					PROP_TAG(PT_LONG,		pidMessageReadOnlyMin+0x08)
#define	PR_RULE_ACTION_TYPE				PROP_TAG(PT_LONG,		pidMessageReadOnlyMin+0x09)
...
#define PR_DELEGATED_BY_RULE			PROP_TAG( PT_BOOLEAN,	pidExchangeXmitReservedMin+0x03)

// Message status bit used to indicate message is in conflict
#define	MSGSTATUS_IN_CONFLICT			((ULONG) 0x0800)
...
#define PR_DELETED_MESSAGE_SIZE_EXTENDED		PROP_TAG(PT_I8,			pidAdminMin+0x0B)

// Total size of all normal soft deleted messages
#define PR_DELETED_NORMAL_MESSAGE_SIZE_EXTENDED	PROP_TAG(PT_I8,			pidAdminMin+0x0C)

// Total size of all associated soft deleted messages
#define PR_DELETED_ASSOC_MESSAGE_SIZE_EXTENDED	PROP_TAG(PT_I8,			pidAdminMin+0x0D)
...
#define	PR_SECURE_IN_SITE				PROP_TAG(PT_BOOLEAN,	pidAdminMin+0x0E)
...
// This property shares the same value with PR_MEMBER_ID because their uses are
// mutually exclusive. Use this property on a message in a PST to get the short
// term EntryID of the parent folder.
#define PR_SHORTTERM_PARENT_ENTRYID_FROM_OBJECT	PROP_TAG(PT_BINARY,	pidSpecialMin + 0x01)

//This property shares the same value with PR_MEMBER_NAME because their
//uses are mutually exclusive.  Use this property on a message in a PST to get the short
//term EntryID of the message.
#define PR_SHORTTERM_ENTRYID_FROM_OBJECT	PROP_TAG(PT_BINARY,		pidSpecialMin + 0x02)
...
#define PR_ORIGINATOR_NAME				PROP_TAG(PT_TSTRING,	pidMessageWriteableMin+0x03)
#define PR_ORIGINATOR_ADDR				PROP_TAG(PT_TSTRING,	pidMessageWriteableMin+0x04)
#define PR_ORIGINATOR_ADDRTYPE			PROP_TAG(PT_TSTRING,	pidMessageWriteableMin+0x05)
#define PR_ORIGINATOR_ENTRYID			PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x06)
#define PR_ARRIVAL_TIME					PROP_TAG(PT_SYSTIME,	pidMessageWriteableMin+0x07)
#define PR_TRACE_INFO					PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x08)
#define PR_INTERNAL_TRACE_INFO 			PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x12)
#define PR_SUBJECT_TRACE_INFO			PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x09)
#define PR_RECIPIENT_NUMBER				PROP_TAG(PT_LONG,		pidMessageWriteableMin+0x0A)
#define PR_MTS_SUBJECT_ID				PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x0B)
#define PR_REPORT_DESTINATION_NAME		PROP_TAG(PT_TSTRING,	pidMessageWriteableMin+0x0C)
#define PR_REPORT_DESTINATION_ENTRYID	PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x0D)
#define PR_CONTENT_SEARCH_KEY			PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x0E)
#define PR_FOREIGN_ID					PROP_TAG(PT_BINARY,		pidMessageWriteableMin+0x0F)
...
/*****											*****/
/* Check MAPIDEFS.H and OMAPIDEFS.H for bits in use */
/*    The list below may not be fully up to date    */
/*****											*****/
...
// Special flag for ModifyAclTable and GetTable (for ACL tables)
...
#define	PR_MEMBER_NAME_A				PROP_TAG(PT_STRING8,	pidSpecialMin+0x02)
#define	PR_MEMBER_NAME_W				PROP_TAG(PT_UNICODE,	pidSpecialMin+0x02)
...
//
// Rights that are for Free/Busy NTSD
//
...
#define EXCHANGE_IEXCHANGEMANAGESTORE_METHODS(IPURE)					\
	MAPIMETHOD(CreateStoreEntryID)										\
		(THIS_	LPCSTR						lpszMsgStoreDN,				\
				LPCSTR						lpszMailboxDN,				\
				ULONG						ulFlags,					\
...
#define PR_FOLDER_PATHNAME_A					PROP_TAG(PT_STRING8,	pidAdminMin+0x25)
#define PR_FOLDER_PATHNAME_W					PROP_TAG(PT_UNICODE,	pidAdminMin+0x25)
...
#define PR_PF_OVER_HARD_QUOTA_LIMIT				PROP_TAG(PT_I8,			pidAdminMin+0x91)
/* the size limit of a message in a public folder */
#define PR_PF_MSG_SIZE_LIMIT					PROP_TAG(PT_I8,			pidAdminMin+0x92)
...
#define EXCHANGE_IEXCHANGEFASTTRANSFER_METHODS(IPURE)			\
	...
	MAPIMETHOD_(BOOL, IsInterfaceOk)								\
...
#define	SYNC_UNICODE						0x00000001
#define SYNC_NO_DELETIONS					0x00000002
#define SYNC_NO_SOFT_DELETIONS				0x00000004
#define	SYNC_READ_STATE						0x00000008
#define SYNC_ASSOCIATED						0x00000010
#define SYNC_NORMAL							0x00000020
#define	SYNC_NO_CONFLICTS					0x00000040
#define SYNC_ONLY_SPECIFIED_PROPS			0x00000080
#define SYNC_NO_FOREIGN_KEYS				0x00000100
#define SYNC_LIMITED_IMESSAGE				0x00000200
#define SYNC_CATCHUP						0x00000400
#define SYNC_NEW_MESSAGE					0x00000800		// only applicable to ImportMessageChange()
#define SYNC_MSG_SELECTIVE					0x00001000		// Used internally.  Will reject if used by clients.
#define SYNC_BEST_BODY						0x00002000		// use the best body logic for sync
#define SYNC_IGNORE_SPECIFIED_ON_ASSOCIATED	0x00004000		// don't allow associated headers
#define SYNC_PROGRESS_MODE					0x00008000		// AirMapi progress mode
#define SYNC_FXRECOVERMODE					0x00010000		// skip bad item
#define SYNC_DEFER_CONFIG					0x00040000		// INTERNAL: Defer ropIncrCfg until first ropFXGetSrcBuffer
...
#define PR_MESSAGE_SITE_NAME				PROP_TAG(PT_TSTRING,	pidExchangeNonXmitReservedMin+0x07)
#define PR_MESSAGE_SITE_NAME_A				PROP_TAG(PT_STRING8,	pidExchangeNonXmitReservedMin+0x07)
#define PR_MESSAGE_SITE_NAME_W				PROP_TAG(PT_UNICODE,	pidExchangeNonXmitReservedMin+0x07)

#define PR_MESSAGE_PROCESSED				PROP_TAG(PT_BOOLEAN,	pidExchangeNonXmitReservedMin+0x08)

#define PR_RULE_MSG_STATE					PROP_TAG(PT_LONG,		pidExchangeNonXmitReservedMin+0x09)
#define PR_RULE_MSG_USER_FLAGS				PROP_TAG(PT_LONG,		pidExchangeNonXmitReservedMin+0x0A)
#define PR_RULE_MSG_PROVIDER_W				PROP_TAG(PT_UNICODE,	pidExchangeNonXmitReservedMin+0x0B)
#define PR_RULE_MSG_NAME_W					PROP_TAG(PT_UNICODE,	pidExchangeNonXmitReservedMin+0x0C)
#define PR_RULE_MSG_LEVEL					PROP_TAG(PT_LONG,		pidExchangeNonXmitReservedMin+0x0D)
#define PR_RULE_MSG_PROVIDER_DATA			PROP_TAG(PT_BINARY, 	pidExchangeNonXmitReservedMin+0x0E)

#define PR_RULE_MSG_SEQUENCE				PROP_TAG(PT_LONG,		pidExchangeNonXmitReservedMin+0x13)
...
#define PR_RULE_SERVER_RULE_ID		PROP_TAG( PT_I8,		pidLISMsgFolderPropMin+0x0)			//	0x65a0 Corresponding server RUID for LIS
...
#define PR_EXTENDED_RULE_MSG_ACTIONS	PROP_TAG(PT_BINARY,		pidStoreNonTransMin+0x59)
#define PR_EXTENDED_RULE_MSG_CONDITION	PROP_TAG(PT_BINARY,		pidStoreNonTransMin+0x5a)

// Used to serialize properties when filtering TNEF - used by Outlook and OWA for saving the original TNEF in cases
// where the TNEF contains Named properties that cannot be created in the store.
...
/*------------------------------------------------------------------------
 *
 *	Retention Policy Tag related properties which determine
 *
 *	These properties are read/write.
 *
 *	DO NOT PUT MORE PROPERTIES HERE!!!!!
 *
 *-----------------------------------------------------------------------*/
...
#define RETENTION_FLAGS_PERSONAL	((ULONG)0x00000008) // whether the folder has
														// a personal or system tag
#define RETENTION_FLAGS_EXPLICIT_ARCHIVE	((ULONG)0x00000010)

#define PR_POLICY_TAG					PROP_TAG(PT_BINARY,		pidMAPIMin + 0x19)
#define PR_RETENTION_PERIOD				PROP_TAG(PT_LONG,		pidMAPIMin + 0x1A)
#define PR_START_DATE_ETC				PROP_TAG(PT_BINARY,		pidMAPIMin + 0x1B)
#define PR_RETENTION_DATE				PROP_TAG(PT_SYSTIME,	pidMAPIMin + 0x1C)
#define PR_RETENTION_FLAGS				PROP_TAG(PT_LONG,		pidMAPIMin + 0x1D)

#define PR_ARCHIVE_TAG					PROP_TAG(PT_BINARY,		pidMAPIMin + 0x18)
#define PR_ARCHIVE_PERIOD				PROP_TAG(PT_LONG,		pidMAPIMin + 0x1E)
#define PR_ARCHIVE_DATE					PROP_TAG(PT_SYSTIME,	pidMAPIMin + 0x1F)

#define PR_SORT_POSITION 				PROP_TAG( PT_BINARY,    pidMAPIMin + 0x20)
#define PR_SORT_PARENTID 				PROP_TAG( PT_BINARY,    pidMAPIMin + 0x21)

// DO NOT PUT MORE PROPERTIES HERE!!!!
//
// The 0x3000 to 0x3FFF range is reserved to MAPI. edkmdb.h defines the
// properties used by the Exchange provider.
//
// If you have a property that applies to any item, it belongs in the MAPI range
// and should be added to omapidefs.h
//
